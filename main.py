...
async def generate_financial_brief() -> str:
    ...
    4. You may name a company outside the tracked list ONLY if it appears verbatim in the tool results, and only as background context — never as a direct comparison or ownership claim about a tracked ticker.
